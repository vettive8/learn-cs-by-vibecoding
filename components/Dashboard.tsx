    ...
    <div className="space-y-12 py-8 animate-in fade-in duration-700">
      <section className="text-center space-y-4 max-w-2xl mx-auto">
        ...
        <p className="text-zinc-400 text-lg">
          Forget the black box. Let's rebuild computer science from the ground up, like tinkering with digital Lego bricks.
        </p>
      </section>
          ...
          >
            ...
            <div className="relative z-10">
              <span className="inline-block px-3 py-1 mb-4 text-xs font-mono font-semibold text-blue-400 bg-blue-500/10 rounded-full border border-blue-500/20">
                Module {lesson.id.split('-')[0]}
              </span>
              <h3 className="text-2xl font-bold mb-2 group-hover:text-blue-400 transition-colors">{lesson.title}</h3>
              <p className="text-zinc-400 text-sm leading-relaxed mb-6">{lesson.description}</p>
